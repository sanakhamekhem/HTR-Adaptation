...
def stage1():
	...
	with open(filepath) as fp:
		...
		for line in fp:
			...
			train_set_path='/home/ahmed/Desktop/sana/RCNN/HTRTF/Projects/MADCAT-WriterDep-Global/Set/list_train.h5'
			validation_set_path='/home/ahmed/Desktop/sana/RCNN/HTRTF/Projects/MADCAT-WriterDep-Global/Set/list_valid.h5'
			test_set_path='/home/ahmed/Desktop/sana/RCNN/HTRTF/Projects/MADCAT-WriterDep-Global/Set/' + writercode + '/list_test.h5'
			## Database location
			output='MADCAT-WriterDep-TL-STAGE-1'
			...
			ValidationLosstmp=0
			transferFLAG =  True
			model_for_transfer_path='/home/ahmed/Desktop/sana/RCNN/HTRTF/train-KHATT/models/'
			testFLAG =False
			sumLoss=0
			## Log file
			if testFLAG:
				...
				for step in range(i_ns, i_num_steps):
				   ...
				   if v < currValLoss:
						...
						if nTimesNoProgress == 10:
							log_file_indicator.write("No progress on validation. Terminating Stage 1.\n")
							log_file_indicator.write("Switching to Stage 2.\n")
