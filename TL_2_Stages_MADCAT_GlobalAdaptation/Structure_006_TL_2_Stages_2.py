...
def stage2():
	...
	with open(filepath) as fp:
		...
		transferFLAG = True 
		testFLAG =False
		restore_checkpoint_at_epoch = 38		
		cnt = 1
		for line in fp:
			...
			stage=2
			ValidationLosstmp=0
			model_for_transfer_path='/home/ahmed/Desktop/sana/RCNN/HTRTF/MADCAT-Experiments/AfterTL/WriterDependent/global/train-MADCAT-WriterDep-TL-STAGE-1/models/'
