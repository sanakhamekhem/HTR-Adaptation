...
def stage2():
	...
	with open(filepath) as fp:
		...
		for line in fp:
			...
			stage=2
			ValidationLosstmp=0
			model_for_transfer_path='/home/ahmed/Desktop/sana/RCNN/HTRTF/MADCAT-Experiments/AfterTL/WriterDependent/specific/train-MADCAT-Dep-TL-STAGE-1-' + writercode +'/models/'
